...
const (
	User_Register_FullMethodName = "/userpb.User/Register"
	User_GetInfo_FullMethodName  = "/userpb.User/GetInfo"
	User_Auth_FullMethodName     = "/userpb.User/Auth"
)
...
func (c *userClient) Auth(ctx context.Context, in *AuthRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (UnimplementedUserServer) Auth(context.Context, *AuthRequest) (*emptypb.Empty, error) {
